...
See wheel [installation](../../../Supply Chain Analyitics/dynamics-365-intelligent-order-management/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
