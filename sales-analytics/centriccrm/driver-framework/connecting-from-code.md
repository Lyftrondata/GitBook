...
See wheel [installation](../../../Sales Analytics/centriccrm/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
