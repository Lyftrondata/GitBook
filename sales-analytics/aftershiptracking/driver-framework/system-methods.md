...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Aftershiptracking](https://www.lyftrondata.com/integration/sales-analytics/aftership-tracking//) provides information about the description and usage of the method in the code.
