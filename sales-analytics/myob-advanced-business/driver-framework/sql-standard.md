...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Myob Advanced Business](None) provides ANSI SQL standard support. A SELECT statement can consist of the following basic clauses.
