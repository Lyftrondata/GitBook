...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Sap Hybris C4C](https://www.lyftrondata.com/integration/sap-hybris-c4c/) provides information about the framework system tables. You can query the system tables with this syntax: <mark style="color:blue;">Select \* from sys.</mark>
