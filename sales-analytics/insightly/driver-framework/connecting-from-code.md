...
See wheel [installation](../../../Sales Analytics/insightly/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
