...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Capsule Crm](https://www.lyftrondata.com/integration/sales-analytics/capsule//) provides information about the description and usage of the method in the code.
