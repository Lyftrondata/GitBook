...
The [Lyftrondata](https://www.lyftrondata.com) driver for [Coppercrm](https://www.lyftrondata.com/integration/sales-analytics/copper/)) requires the below versions
