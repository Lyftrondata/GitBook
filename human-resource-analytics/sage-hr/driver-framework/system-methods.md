...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Sage Hr](https://www.lyftrondata.com/integration/sage-hr/) provides information about the description and usage of the method in the code.
