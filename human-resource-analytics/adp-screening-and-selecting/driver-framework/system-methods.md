...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Adp Screening And Selecting](None/) provides information about the description and usage of the method in the code.
