...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Sage Hr Advice Manager](https://www.lyftrondata.com/integration/sage-hr-advice-manager/) provides information about the description and usage of the method in the code.
