...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Adp Work Force Now](None/) provides information about the description and usage of the method in the code.
