...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Adp Work Force Now](https://www.lyftrondata.com/integration/adp-work-force-now/) provides the connection string steps documented below. For more detailed information about driver connectivity, visit the [Connection Steps](../../../erp/dynamics-365-business-central/connection-steps.md) section of this document.
