...
The [Lyftrondata](https://www.lyftrondata.com) driver for [Square](https://www.lyftrondata.com/integration/commerce-analytics/square/)) requires the below versions
