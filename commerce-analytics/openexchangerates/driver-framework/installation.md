...
The [Lyftrondata](https://www.lyftrondata.com) driver for [Openexchangerates](https://www.lyftrondata.com/integration/commerce-analytics/openexchange-rate/)) requires the below versions
