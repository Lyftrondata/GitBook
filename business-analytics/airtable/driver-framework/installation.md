...
The [Lyftrondata](https://www.lyftrondata.com) driver for [Airtable](https://www.lyftrondata.com/integration/business-analytics/airtable/)) requires the below versions
