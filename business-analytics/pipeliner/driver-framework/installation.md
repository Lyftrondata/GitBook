...
The [Lyftrondata](https://www.lyftrondata.com) driver for [Pipeliner](https://www.lyftrondata.com/integration/sales-analytics/pipeliner/)) requires the below versions
