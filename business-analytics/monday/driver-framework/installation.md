...
The [Lyftrondata](https://www.lyftrondata.com) driver for [Monday](https://www.lyftrondata.com/integration/business-analytics/monday/)) requires the below versions
