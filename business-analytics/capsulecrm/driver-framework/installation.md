...
The [Lyftrondata](https://www.lyftrondata.com) driver for [Capsulecrm](https://www.lyftrondata.com/integration/sales-analytics/capsule/)) requires the below versions
