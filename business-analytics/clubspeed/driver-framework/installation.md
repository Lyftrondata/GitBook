...
The [Lyftrondata](https://www.lyftrondata.com) driver for [Clubspeed](https://www.lyftrondata.com/integration/sales-analytics/clubspeed/)) requires the below versions
