...
The [Lyftrondata](https://www.lyftrondata.com) driver for [Zoho Lens](https://www.lyftrondata.com/integration/commerce-analytics/zoho-lens/)) requires the below versions
