...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Zoho Lens](https://www.lyftrondata.com/integration/commerce-analytics/zoho-lens//) provides information about the description and usage of the method in the code.
