...
The [Lyftrondata](https://www.lyftrondata.com) driver for [Timely](https://www.lyftrondata.com/integration/business-analytics/timely/)) requires the below versions
