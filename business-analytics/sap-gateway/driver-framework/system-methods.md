...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Sap Gateway](https://www.lyftrondata.com/integration/sap-gateway/) provides information about the description and usage of the method in the code.
