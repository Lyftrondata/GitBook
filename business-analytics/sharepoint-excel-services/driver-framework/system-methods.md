...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Sharepoint Excel Services](None/) provides information about the description and usage of the method in the code.
