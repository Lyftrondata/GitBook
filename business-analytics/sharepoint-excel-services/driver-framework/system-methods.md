...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Sharepoint Excel Services](https://www.lyftrondata.com/integration/sharepoint-excel-services/) provides information about the description and usage of the method in the code.
