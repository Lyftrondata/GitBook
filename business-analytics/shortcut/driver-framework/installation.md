...
The [Lyftrondata](https://www.lyftrondata.com) driver for [Shortcut](https://www.lyftrondata.com/integration/business-analytics/shortcut/)) requires the below versions
