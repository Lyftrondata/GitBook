...
The [Lyftrondata](https://www.lyftrondata.com) driver for [Helpscout](https://www.lyftrondata.com/integration/business-analytics/helpscout/)) requires the below versions
