...
The [Lyftrondata](https://www.lyftrondata.com) driver for [Spotify](https://www.lyftrondata.com/integration/commerce-analytics/spotify/)) requires the below versions
