...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Seomonitor ](../../seomonitor-/driver-framework/None/)provides information about the description and usage of the method in the code.
