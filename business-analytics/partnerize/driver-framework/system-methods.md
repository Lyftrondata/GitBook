...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Partnerize](../../-partnerize/driver-framework/None/) provides information about the description and usage of the method in the code.
