...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Repairshoper](https://www.lyftrondata.com/integration/repairshoper/) provides the connection string steps documented below. For more detailed information about driver connectivity, visit the [Connection Steps](../../../erp/dynamics-365-business-central/connection-steps.md) section of this document.
