...
The [Lyftrondata](https://www.lyftrondata.com) driver for [Zoho Inventory](https://www.lyftrondata.com/integration/business-analytics/zoho-inventory/)) requires the below versions
