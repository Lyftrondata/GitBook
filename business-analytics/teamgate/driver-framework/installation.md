...
The [Lyftrondata](https://www.lyftrondata.com) driver for [Teamgate](https://www.lyftrondata.com/integration/sales-analytics/teamgate/)) requires the below versions
