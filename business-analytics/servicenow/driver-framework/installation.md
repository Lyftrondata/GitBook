...
The [Lyftrondata](https://www.lyftrondata.com) driver for [Servicenow](https://www.lyftrondata.com/integration/business-analytics/service-now/)) requires the below versions
