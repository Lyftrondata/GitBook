...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Sage Fixed Assets](https://www.lyftrondata.com/integration/sage-fixed-assets/) provides ANSI SQL standard support. A SELECT statement can consist of the following basic clauses.
