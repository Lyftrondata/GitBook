...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Sage Fixed Assets](https://www.lyftrondata.com/integration/sage-fixed-assets/) provides information about the description and usage of the method in the code.
