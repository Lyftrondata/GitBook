...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Linkedin Plugin](https://www.lyftrondata.com/integration/linkedin-plugin/) provides information about the description and usage of the method in the code.
