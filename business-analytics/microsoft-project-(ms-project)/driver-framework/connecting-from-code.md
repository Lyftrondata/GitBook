...
See wheel [installation](../../../Business Analytics/microsoft-project-(ms-project)/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
