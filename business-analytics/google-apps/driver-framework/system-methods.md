...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Google Apps](https://www.lyftrondata.com/integration/google-apps/) provides information about the description and usage of the method in the code.
