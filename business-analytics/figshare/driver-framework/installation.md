...
The [Lyftrondata](https://www.lyftrondata.com) driver for [Figshare](https://www.lyftrondata.com/integration/business-analytics/figshare/)) requires the below versions
