...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Dynamics 365 Remote Assist](None/) provides information about the description and usage of the method in the code.
