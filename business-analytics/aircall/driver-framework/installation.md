...
The [Lyftrondata](https://www.lyftrondata.com) driver for [Aircall](https://www.lyftrondata.com/integration/business-analytics/linkedin-plugin/)) requires the below versions
