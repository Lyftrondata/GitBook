...
See wheel [installation](../../../Business Analytics/microsoft-planner-(ms-planner)/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
