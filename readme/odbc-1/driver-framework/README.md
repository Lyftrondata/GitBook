...
The [Lyftrondata](https://www.lyftrondata.com/) integration for [Odbc](../../../business-analytics/odbc/driver-framework/None/) provides the most natural way to access data while requiring no engineering.
...
* [ ] [Data Model](../../../business-analytics/odbc/data-model/erd.md)
