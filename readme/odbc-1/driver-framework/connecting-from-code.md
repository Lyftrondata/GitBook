...
See wheel \[installation]\(../../../Business Analytics/odbc/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
