...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Adrecord ](../../adrecord-/driver-framework/None/)provides information about the description and usage of the method in the code.
