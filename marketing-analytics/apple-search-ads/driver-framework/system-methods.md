...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Apple Search Ads](https://www.lyftrondata.com/integration/apple-search-ads/) provides information about the description and usage of the method in the code.
