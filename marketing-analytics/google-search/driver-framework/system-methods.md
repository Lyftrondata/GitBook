...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Google Search](https://www.lyftrondata.com/integration/google-search/) provides information about the description and usage of the method in the code.
