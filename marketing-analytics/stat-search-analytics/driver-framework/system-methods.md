...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Stat Search Analytics](https://www.lyftrondata.com/integration/stat-search-analytics/) provides information about the description and usage of the method in the code.
