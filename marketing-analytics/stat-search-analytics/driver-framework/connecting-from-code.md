...
See wheel [installation](../../../Marketing Analytics/stat-search-analytics/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
