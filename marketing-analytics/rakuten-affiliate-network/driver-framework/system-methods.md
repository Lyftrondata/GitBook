...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Rakuten Affiliate Network](https://www.lyftrondata.com/integration/rakuten-affiliate-network/) provides information about the description and usage of the method in the code.
