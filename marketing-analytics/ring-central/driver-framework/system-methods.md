...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Ring Central](https://www.lyftrondata.com/integration/ring-central/) provides information about the description and usage of the method in the code.
