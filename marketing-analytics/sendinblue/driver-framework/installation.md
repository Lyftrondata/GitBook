...
The [Lyftrondata](https://www.lyftrondata.com) driver for [Sendinblue](https://www.lyftrondata.com/integration/marketing-analytics/sendinblue/)) requires the below versions
