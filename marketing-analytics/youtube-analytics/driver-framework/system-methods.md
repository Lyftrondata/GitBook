...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Youtube Analytics](https://www.lyftrondata.com/integration/youtube-analytics/) provides information about the description and usage of the method in the code.
