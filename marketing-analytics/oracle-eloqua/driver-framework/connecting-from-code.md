...
See wheel [installation](../../../Marketing Analytics/oracle-eloqua/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
