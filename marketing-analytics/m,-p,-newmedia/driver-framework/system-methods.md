...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [M, P, Newmedia](https://www.lyftrondata.com/integration/m,-p,-newmedia/) provides information about the description and usage of the method in the code.
