...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Match2One](https://www.lyftrondata.com/integration/match2one/) provides information about the description and usage of the method in the code.
