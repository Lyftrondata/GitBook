...
The [Lyftrondata](https://www.lyftrondata.com) driver for [Clicksend](https://www.lyftrondata.com/integration/marketing-analytics/click-send/)) requires the below versions
