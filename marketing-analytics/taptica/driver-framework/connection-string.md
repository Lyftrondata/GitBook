...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Taptica](https://www.lyftrondata.com/integration/taptica/) provides the connection string steps documented below. For more detailed information about driver connectivity, visit the [Connection Steps](../../../erp/dynamics-365-business-central/connection-steps.md) section of this document.
