...
See wheel [installation](../../../Marketing Analytics/sizmek-advertising-suite/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
