...
The [Lyftrondata](https://www.lyftrondata.com) driver for [Partnerize](https://www.lyftrondata.com/integration/marketing-analytics/partnerize/ )) requires the below versions
