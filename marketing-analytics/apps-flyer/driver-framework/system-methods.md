...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Apps Flyer](https://www.lyftrondata.com/integration/apps-flyer/) provides information about the description and usage of the method in the code.
