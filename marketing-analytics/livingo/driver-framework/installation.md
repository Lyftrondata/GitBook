...
The [Lyftrondata](https://www.lyftrondata.com) driver for [Livingo](https://www.lyftrondata.com/integration/marketing-analytics/livingo/)) requires the below versions
