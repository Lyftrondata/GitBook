...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Target Circle](https://www.lyftrondata.com/integration/target-circle/) provides information about the description and usage of the method in the code.
