...
See wheel [installation](../../../Marketing Analytics/the-trade-desk/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
