...
See wheel [installation](../../../Marketing Analytics/powerinbox/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
