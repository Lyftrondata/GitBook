...
See wheel [installation](../../../Marketing Analytics/ad-up-technology/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
