...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Inside Response](https://www.lyftrondata.com/integration/inside-response/) provides information about the description and usage of the method in the code.
