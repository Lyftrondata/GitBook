...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Doubleclick Campaign Manager](https://www.lyftrondata.com/integration/doubleclick-campaign-manager/) provides information about the description and usage of the method in the code.
