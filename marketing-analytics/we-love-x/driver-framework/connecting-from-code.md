...
See wheel [installation](../../../Marketing Analytics/we-love-x/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
