...
See wheel [installation](../../../Marketing Analytics/jump-ramp-games/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
