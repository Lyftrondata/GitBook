...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Google Analytics](https://www.lyftrondata.com/integration/google-analytics/) provides information about the description and usage of the method in the code.
