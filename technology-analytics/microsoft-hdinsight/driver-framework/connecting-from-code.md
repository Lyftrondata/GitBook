...
See wheel [installation](../../../Technology Analytics/microsoft-hdinsight/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
