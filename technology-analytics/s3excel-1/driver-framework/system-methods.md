...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [S3Excel](../../s3excel/driver-framework/None/) provides information about the description and usage of the method in the code.
