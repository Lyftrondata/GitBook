...
See wheel \[installation]\(../../../Technology Analytics/s3excel/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
