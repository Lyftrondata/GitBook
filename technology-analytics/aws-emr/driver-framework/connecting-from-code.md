...
See wheel [installation](../../../Technology Analytics/aws-emr/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
