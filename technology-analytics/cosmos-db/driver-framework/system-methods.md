...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Cosmos Db](https://www.lyftrondata.com/integration/cosmos-db/) provides information about the description and usage of the method in the code.
