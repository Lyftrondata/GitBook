...
See wheel [installation](../../../Technology Analytics/apache-hive/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
