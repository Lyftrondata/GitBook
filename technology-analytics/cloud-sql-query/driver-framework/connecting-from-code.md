...
See wheel [installation](../../../Technology Analytics/cloud-sql-query/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
