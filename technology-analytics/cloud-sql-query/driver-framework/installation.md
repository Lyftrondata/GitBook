...
The [Lyftrondata](https://www.lyftrondata.com) driver for [Cloud Sql Query](https://www.lyftrondata.com/integration/cloud-sql-query/)[ ](https://www.lyftrondata.com/integration/cloud-sql-query/)requires the below versions
