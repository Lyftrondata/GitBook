...
The [Lyftrondata](https://www.lyftrondata.com) driver for [Bigquery](https://www.lyftrondata.com/integration/data-warehouse/google-bigquery/)) requires the below versions
