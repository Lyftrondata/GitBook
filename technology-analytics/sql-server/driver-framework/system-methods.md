...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Sql Server](https://www.lyftrondata.com/integration/sql-server/) provides information about the description and usage of the method in the code.
