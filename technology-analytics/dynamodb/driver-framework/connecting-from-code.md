...
See wheel [installation](../../../Technology Analytics/dynamodb/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
