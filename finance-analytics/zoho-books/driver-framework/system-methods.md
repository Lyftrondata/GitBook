...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Zoho Books](https://www.lyftrondata.com/integration/finance-analytics/zohobooks//) provides information about the description and usage of the method in the code.
