...
See wheel [installation](../../../Finance Analytics/microsoft-dynamic-nav/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
