...
See wheel [installation](../../../Finance Analytics/exact-online/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
