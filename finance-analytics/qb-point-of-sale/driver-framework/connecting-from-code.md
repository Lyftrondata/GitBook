...
See wheel [installation](../../../Finance Analytics/qb-point-of-sale/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
