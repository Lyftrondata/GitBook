...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Qb Point Of Sale](None/) provides information about the description and usage of the method in the code.
