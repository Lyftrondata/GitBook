...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Adp Smart Compliance](None/) provides information about the description and usage of the method in the code.
