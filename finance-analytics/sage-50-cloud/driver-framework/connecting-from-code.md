...
See wheel [installation](../../../Finance Analytics/sage-50-cloud/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
