...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Sage 50 Cloud](None/) provides information about the description and usage of the method in the code.
