...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Sap Netweaver](None/) provides information about the description and usage of the method in the code.
