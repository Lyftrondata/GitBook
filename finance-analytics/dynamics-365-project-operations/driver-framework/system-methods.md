...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Dynamics 365 Project Operations](None/) provides information about the description and usage of the method in the code.
