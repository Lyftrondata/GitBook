...
The [Lyftrondata](https://www.lyftrondata.com) driver for [AccumaticaOdataERP](https://lyftron.com/source/data-migration-from-acumatica-to-snowflake-google-bigquery-amazon-redshift-and-azure-sql-database/)) requires the below versions
