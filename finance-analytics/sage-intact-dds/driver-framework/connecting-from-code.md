...
See wheel [installation](../../../Finance Analytics/sage-intact-dds/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
