...
The [Lyftrondata](https://www.lyftrondata.com/) driver for [Blackbaud Fe Nxt](None/) provides information about the description and usage of the method in the code.
