...
See wheel [installation](../../../Finance Analytics/blackbaud-fe-nxt/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
