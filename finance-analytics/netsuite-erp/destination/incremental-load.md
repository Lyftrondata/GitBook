...
<table data-header-hidden><thead><tr><th width="205">Column</th><th>Description</th></tr></thead><tbody><tr><td>Last_Modified_Date</td><td>Date filtering is supported in fewer endpoints which have Last Date Modified.</td></tr></tbody></table>
