...
See wheel [installation](../../../Finance Analytics/sage-200/driver-framework/installation.md) for the prerequisite information you need to deploy the source connector.
